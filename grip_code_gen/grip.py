...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_0_hue = [12.949640287769784, 43.652789691737695]
        self.__hsv_threshold_0_saturation = [127.01372800065032, 204.47254111076637]
        self.__hsv_threshold_0_value = [98.60611510791368, 152.8358672044679]

        self.hsv_threshold_0_output = None

        self.__hsv_threshold_1_input = self.blur_output
        self.__hsv_threshold_1_hue = [17.805755395683452, 37.16723549488056]
        self.__hsv_threshold_1_saturation = [101.65503190667803, 248.1818181818182]
        self.__hsv_threshold_1_value = [130.71043165467628, 255.0]
